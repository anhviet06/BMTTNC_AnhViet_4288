...
def rsa_encrypt():
    ...
    # Trả về hex để Postman dễ hiển thị
...
def rsa_sign_message():
    data = request.json
    message = data['message']
    # Vì load_keys trả về (private, public), nên ta lấy biến đầu tiên
...
def rsa_verify_signature():
    ...
    # Vì load_keys trả về (private, public), nên ta lấy biến thứ hai
